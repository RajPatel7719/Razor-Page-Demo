...
//the above service takes in the partial view name and model as the input parameters, tries to find the Razor View,
//renders it to HTML String and returns the string.
